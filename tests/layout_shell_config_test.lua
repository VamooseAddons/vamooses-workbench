-- The app-shell LayoutConfig resolves: sidebar (fixed 150) | content (flex),
...
check("sidebar fixed 150 on the left", near(sidebar.rect.w, 150) and near(sidebar.rect.x, 0))
check("content flexes right of sidebar", near(content.rect.w, 890) and near(content.rect.x, 150))
